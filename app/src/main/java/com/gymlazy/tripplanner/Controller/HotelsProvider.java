...
*	FILE: HotelsProvider.java
*	PROGRAMMER: Nghia Nguyen
*	FIRST VERSION: 2021/05/06
*	DESCRIPTION:
		This file contains the HotelsProvider class used for creating a content provider that used for providing information about hotels
*/
